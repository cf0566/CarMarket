...
public class FormOnServiceActivity extends BaseActivity {

	private TextView tvCar, tvUser, tvPhone, tvAddress, tvType, tvPrice,
			tvTime, tvPay, tvNum, tvCreat;
	...
	protected void loadXml() {
		setContentView(R.layout.activity_form_on_service);
	}
	
	@Override
	protected void initView() {
		tvCar = (TextView) findViewById(R.id.activity_form_on_service_tv_car);
		tvUser = (TextView) findViewById(R.id.activity_form_on_service_tv_user);
		tvPhone = (TextView) findViewById(R.id.activity_form_on_service_tv_phone);
		tvAddress = (TextView) findViewById(R.id.activity_form_on_service_tv_address);
		tvType = (TextView) findViewById(R.id.activity_form_on_service_tv_type);
		tvPrice = (TextView) findViewById(R.id.activity_form_on_service_tv_price);
		tvTime = (TextView) findViewById(R.id.activity_form_on_service_tv_time);
		tvPay = (TextView) findViewById(R.id.activity_form_on_service_tv_pay);
		tvNum = (TextView) findViewById(R.id.activity_form_on_service_tv_num);
		tvCreat = (TextView) findViewById(R.id.activity_form_on_service_tv_creat_time);
		
		ivBack = (ImageView) findViewById(R.id.activity_form_on_service_iv_back);
	...
	protected void initData() {
		sp = PreferenceManager.getDefaultSharedPreferences(FormOnServiceActivity.this);
