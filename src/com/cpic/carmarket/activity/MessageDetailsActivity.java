...
public class MessageDetailsActivity extends BaseActivity{
	...
	protected void registerListener() {
		btnOnline.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				intent = new Intent(MessageDetailsActivity.this, AnswerOnlineResponseActivity.class);
	...
	private void loadDatas() {
		...
		post.send(HttpMethod.POST, UrlUtils.postUrl+UrlUtils.path_messageDetail ,params, new RequestCallBack<String>() {
			...
			public void onSuccess(ResponseInfo<String> arg0) {
				...
				details = JSONObject.parseObject(arg0.result, MessageDetails.class);
				int code = details.getCode();
				if (code == 1) {
					MessageDetailsData data = details.getData();
