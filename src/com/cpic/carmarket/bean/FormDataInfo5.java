...
public class FormDataInfo5 {
	...
	public void setBack(JSONObject back) {
		this.back = back;
	}
	public FormDataInfo5() {
		super();
		// TODO Auto-generated constructor stub
	}
	@Override
	public String toString() {
		return "FormDataInfo5 [car_name=" + car_name + ", order_id=" + order_id
				...
				+ merchant_date + ", evaluation_date=" + evaluation_date
				+ ", back=" + back + "]";
	}
}
