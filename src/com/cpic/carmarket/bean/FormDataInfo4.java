...
public class FormDataInfo4 {
	...
	private FormDataInfoDetails4 evaluation;
	...
	public FormDataInfoDetails4 getEvaluation() {
		return evaluation;
	}
	public void setEvaluation(FormDataInfoDetails4 evaluation) {
	...
	public String toString() {
		return "FormDataInfo4 [car_name=" + car_name + ", order_id=" + order_id
				+ ", order_amount=" + order_amount + ", pay_id=" + pay_id
				+ ", pay_status=" + pay_status + ", order_status="
